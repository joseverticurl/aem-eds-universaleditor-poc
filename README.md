...
## Environments
- Preview: https://main--aem-eds-universaleditor-training--joseverticurl.aem.page/
- Live: https://main--aem-eds-universaleditor-training--joseverticurl.aem.live/
...
1. Open the `aem-eds-universaleditor-training` directory in your favorite IDE and start coding :)
